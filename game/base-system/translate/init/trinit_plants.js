function trinit_plants()
{
	if (!setup.trPlants)
	{
		...
		for (const trPlantsData of setup.trPlants)
		{
			...
			if (trPlantsData.recipe_name)
				trPlantsRecipeNameIndex[trPlantsData.recipe_name] = trPlantsData;
		}
		setup.trPlants.nameIndex = Object.assign(trPlantsNameIndex, trPlantsSingularIndex, trPlantsPluralIndex, trPlantsRecipeNameIndex);
	}
}
