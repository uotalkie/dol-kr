...
window.koTrans = {
	...
	"warning":
		...
		'<p><<link "네. 나는 법적으로 성인이며 모든 책임을 자신이 지겠다고 확인합니다.">><<set _warningConfirm to true>><<replace "#settingsStart">><<settingsStart>><</replace>><<replace "#startCaption">><<startCaption>><</replace>><</link>><br>' +
